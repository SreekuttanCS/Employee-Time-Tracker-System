                            ...
                            if (isset($_GET["emp_id"])) {
                                ...
                                if (mysqli_num_rows($result) > 0) {
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        // Options column with Edit and Delete links
                                        echo "<td>
                                                <a href='employee-edit.php?emp_id=" . $row['emp_id'] . "' class='btn btn-warning btn-sm'><i class='bi bi-pencil'></i> Edit</a>
                                                <a href='employee-delete.php?emp_id=" . $row['emp_id'] . "' class='btn btn-danger btn-sm' onclick='return confirm(\"Are you sure you want to delete this employee?\");'><i class='bi bi-trash'></i> Delete</a>
                                              </td>";
                                        echo "</tr>";
                                    }
                                } else {
