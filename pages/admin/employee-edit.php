					...
					<div class="card py-5 px-4">
						<form action="employee-edit-form.php" method="post" class="register_form row g-3">
							...
							<div class="col-md-4">
								...
								<input type="text" class="form-control" id="input-middle-name" name="input-middle-name" placeholder="Enter middle name" value="<?php echo $middle_name ?>" required>
							</div>
							<div class="col-md-4">
							...
							<div class="col-md-8">
								...
								<input type="email" class="form-control" id="input-email-address" name="input-email-address" placeholder="example123@email.com" value="<?php echo $email_address ?>" required>
							</div>
							...
							<div class="col-md-4">
								...
								<select id="input-employee-contract" name="input-employee-contract" class="form-select" required>
									<option value="Part Time" <?php echo ($contract == 'Part Time') ? 'selected' : ''; ?>>Part Time</option>
									<option value="Full Time" <?php echo ($contract == 'Full Time') ? 'selected' : ''; ?>>Full Time</option>
								</select>
							</div>
							...
							<div class="col-md-4">
								...
								<select id="input-shift" name="input-shift" class="form-select" required>
									<option value="Morning Shift" <?php echo ($shift == 'Morning Shift') ? 'selected' : ''; ?>>Morning Shift</option>
									<option value="Afternoon Shift" <?php echo ($shift == 'Afternoon Shift') ? 'selected' : ''; ?>>Afternoon Shift</option>
									<option value="Day Shift" <?php echo ($shift == 'Day Shift') ? 'selected' : ''; ?>>Day Shift</option>
								</select>
							</div>

							<div class="col-md-4">
								<label for="inputPassword4" class="form-label">Password</label>
								<input type="password" class="form-control" id="input-password" name="input-password" placeholder="Enter employee password" required>
							</div>
